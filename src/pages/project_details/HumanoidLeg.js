  ...
  >
    <article className="post" id="projects">
      ...
      <div className="project_content">
        ...
        <div className="other2"><img width="15%" src={`${process.env.PUBLIC_URL}${'/images/projects/HumanoidLegV1.svg'}`} alt="details" /><iframe width="20%" height="300px" src="https://www.youtube.com/embed/BY0Mm_o7VOU" allow="autoplay; encrypted-media" allowfullscreen="true" title="video" /><iframe width="20%" height="300px" src="https://www.youtube.com/embed/51Og5FFTkmw" allow="autoplay; encrypted-media" allowfullscreen="true" title="video" /><iframe width="20%" height="300px" src="https://www.youtube.com/embed/6oS0yz-fUf0" allow="autoplay; encrypted-media" allowfullscreen="true" title="video" /></div>
